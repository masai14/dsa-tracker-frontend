...
const Login = () => {
  ...
  const signIn = () => {
    ...
    fetch(
      "https://dsa-tracker-api.herokuapp.com/user/auth/login/",
      requestOptions
    )
      .then((response) => response.json())
      .then((result) => {
  ...
  return (
    <div className={LoginPageCSS.body}>
      <div className={LoginPageCSS.container} id="container">
        {/* sign up container */}
        <div
          className={`${LoginPageCSS.formContainer} ${LoginPageCSS.signUpContainer}`}
        >
          <form
          ...
          >
            ...
            <div className={LoginPageCSS.socialContainer}>
              <a
                ...
                className={`${LoginPageCSS.social} ${LoginPageCSS.a}`}
              >
                <FaFacebookF />
              </a>
              <a
            ...
            <span className={LoginPageCSS.span}>
        ...
        {/* Sign in container */}
        <div
          className={`${LoginPageCSS.formContainer} ${LoginPageCSS.signInContainer}`}
        >
          <form
            className={LoginPageCSS.form}
            onSubmit={(event) => {
        ...
        <div className={LoginPageCSS.overlayContainer}>
          <div className={LoginPageCSS.overlay}>
            <div
              className={`${LoginPageCSS.overlayPanel} ${LoginPageCSS.overlayLeft}`}
            >
              <h1 className={LoginPageCSS.h1}>Welcome Back!</h1>
              <p className={LoginPageCSS.p}>
            ...
            <div
              className={`${LoginPageCSS.overlayPanel} ${LoginPageCSS.overlayRight}`}
            >
