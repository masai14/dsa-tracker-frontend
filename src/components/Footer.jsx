  ...
  return (
    <footer className={`ml-[${marginLeft}] h-10 p-4 bg-white shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800`}>
      ...
      <ul className="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
        <li>
          <a href="/notyetimplmented" className="mr-4 hover:underline md:mr-6 ">About</a>
        </li>
        <li>
          <a href="/notyetimplmented" className="mr-4 hover:underline md:mr-6">Privacy Policy</a>
        </li>
        <li>
          <a href="/notyetimplmented" className="mr-4 hover:underline md:mr-6">Licensing</a>
        </li>
        <li>
          <a href="/notyetimplmented" className="hover:underline">Contact</a>
        </li>
      </ul>
    </footer>
  )
