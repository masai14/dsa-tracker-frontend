...
export const Modal = () => {
    const [sample, setSample] = useState("second");
    useEffect(() => {
                ...
                <form className="space-y-4 p-8">
                    <div className='flex gap-6'>
                        ...
                        <div className='grow'>
                            ...
                            <input type="text" name="topic" id="topic" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Array,Binary Search,..." required />
                        </div>
                    </div>
                    <div>
                        ...
                        <textarea type="text" name="description" id="description" placeholder={`Suppose an array sorted in ascending order is rotated at some pivot unknown to you beforehand. (i.e., [1, 4, 6, 8, 11, 13, 15] might become [8, 11, 13, 15, 1, 4, 6]).
...
You may assume no duplicate exists in the array. Your algorithm’s runtime complexity must be in the order of O(log n).`} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white h-[8rem]" required />
                    ...
                    <div className='flex flex-row gap-6'>
                        <div className='grow'>
                            ...
                            <textarea type="text" name="link" id="link" placeholder="https://leetcode.com/problems/search-in-rotated-sorted-array/" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white h-12" required />
                        </div>
                        <div className='grow'>
                            ...
                            <textarea type="text" name="platform" id="platform" placeholder="Leetcode" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white h-12" required />
                        </div>
                        <div className='grow'>
                    ...
                    <div className='flex flex-row gap-6'>
                        <div className='grow'>
                            ...
                            <textarea type="text" name="intuition" id="intuition" placeholder="You have given an array which is sorted and rotated, and a target value, you need to return return the index of the target." className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white h-[12rem]" required />
                        </div>
                        <div className='grow'>
                            ...
                            <textarea type="text" name="code" id="code" placeholder="You have given an array which is sorted and rotated, and a target value, you need to return return the index of the target." className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white h-[12rem]" required />
                        </div>
                    </div>

                    <div className='flex flex-row gap-10'>
                        <div>
                            <input type="checkbox" name="status" id="" className='mr-2 w-4 h-4' />
                    ...
                    <button type="button" className='p-2  px-8 rounded-lg text-white font-semibold text-lg bg-[#1072B9]'>
                        Add
